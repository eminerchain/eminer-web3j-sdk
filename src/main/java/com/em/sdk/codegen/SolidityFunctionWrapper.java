...
import com.em.sdk.abi.datatypes.DynamicArray;
...
import com.em.sdk.abi.datatypes.generated.AbiTypes;
...
import com.em.sdk.core.protocol.core.methods.response.AbiDefinition;
...
import com.em.sdk.core.utils.Collection;
import com.em.sdk.core.utils.Version;
import com.em.sdk.crypto.Credentials;
import com.em.sdk.utils.Strings;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    TypeSpec buildEventResponseObject(
            String className,
            List<com.em.sdk.codegen.SolidityFunctionWrapper.NamedTypeName> indexedParameters,
            List<com.em.sdk.codegen.SolidityFunctionWrapper.NamedTypeName> nonIndexedParameters) {

        TypeSpec.Builder builder = TypeSpec.classBuilder(className)
                .addModifiers(Modifier.PUBLIC, Modifier.STATIC);

        builder.addField(LOG, "log", Modifier.PUBLIC);
        for (com.em.sdk.codegen.SolidityFunctionWrapper.NamedTypeName
    ...
    MethodSpec buildEventObservableFunction(
        ...
        MethodSpec.Builder observableMethodBuilder =
                MethodSpec.methodBuilder(generatedFunctionName)
                        .addModifiers(Modifier.PUBLIC)
                        .addParameter(EMFilter.class, FILTER)
    ...
    MethodSpec buildDefaultEventObservableFunction(
        ...
        observableMethodBuilder.addStatement("$1T filter = new $1T($2L, $3L, "
                + "getContractAddress())", EMFilter.class, START_BLOCK, END_BLOCK)
        ...
        for (AbiDefinition.NamedType namedType : inputs) {
            ...
            if (namedType.isIndexed()) {
                indexedParameters.add(
                        new com.em.sdk.codegen.SolidityFunctionWrapper.NamedTypeName(
                                namedType.getName(),
