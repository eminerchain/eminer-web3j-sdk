package com.em.sdk.core.ens;


import com.em.sdk.core.ens.contracts.generated.ENS;
import com.em.sdk.core.ens.contracts.generated.PublicResolver;
...
import com.em.sdk.core.tx.ClientTransactionManager;
import com.em.sdk.core.tx.ManagedTransaction;
import com.em.sdk.core.tx.TransactionManager;
import com.em.sdk.crypto.WalletUtils;
...
public class EnsResolver {
    ...
    PublicResolver lookupResolver(String ensName) throws Exception {
        ...
        ENS ensRegistry = ENS.load(
                ...
                ManagedTransaction.GAS_PRICE, com.em.sdk.core.tx.Contract.GAS_LIMIT);
    ...
    boolean isSynced() throws Exception {
        EMSyncing ethSyncing = web3j.emSyncing().send();
        if (ethSyncing.isSyncing()) {
            return false;
        } else {
            EMBlock ethBlock =
                    web3j.emGetBlockByNumber(DefaultBlockParameterName.LATEST, false).send();
