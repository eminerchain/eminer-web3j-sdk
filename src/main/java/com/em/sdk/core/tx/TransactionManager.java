...
import com.em.sdk.core.tx.response.PollingTransactionReceiptProcessor;
import com.em.sdk.core.tx.response.TransactionReceiptProcessor;

import java.io.IOException;
import java.math.BigInteger;

import static com.em.sdk.core.protocol.core.JsonRpc2_0Web3j.DEFAULT_BLOCK_TIME;
...
public abstract class TransactionManager {
    ...
    protected TransactionReceipt executeTransaction(
        ...
        EMSendTransaction ethSendTransaction = sendTransaction(
                gasPrice, gasLimit, to, data, value);
        return processResponse(ethSendTransaction);
    }

    public abstract EMSendTransaction sendTransaction(
            BigInteger gasPrice, BigInteger gasLimit, String to,
            String data, BigInteger value)
            throws IOException;
    ...
    private TransactionReceipt processResponse(EMSendTransaction transactionResponse)
            throws IOException, TransactionException {
