...
import com.em.sdk.abi.FunctionReturnDecoder;
...
import com.em.sdk.core.tx.exceptions.ContractCallException;
...
public abstract class Contract extends ManagedTransaction {
    ...
    public boolean isValid() throws IOException {
        ...
        EMGetCode ethGetCode = web3j
                .emGetCode(contractAddress, DefaultBlockParameterName.LATEST)
                .send();
    ...
    private List<Type> executeCall(
        ...
        EMCall ethCall = web3j.emCall(
                Transaction.createEMCallTransaction(
