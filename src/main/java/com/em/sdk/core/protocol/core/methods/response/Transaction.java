...
/**
 * Transaction object used by both {@link EMTransaction} and {@link EMBlock}.
 */
@Data
@Builder
@AllArgsConstructor
public class Transaction {
    ...
    private EMAssetInfo.AssetInfo assetInfo;
    ...
    public Transaction(String hash, String nonce, String blockHash, String blockNumber,
                       ...
                       List<VoteInterface> votes, String asset, String subAddress, EMAssetInfo.AssetInfo assetInfo,
                       String abi) {
        this.hash = hash;
        this.nonce = nonce;
        this.blockHash = blockHash;
...
//    }
    ...
    public static class VoteOperationObject extends EMVoteOperation.VoteOperation
        implements VoteInterface<EMVoteOperation.VoteOperation> {
        ...
        @Override
        public EMVoteOperation.VoteOperation get() {
            return this;
        }
    }
