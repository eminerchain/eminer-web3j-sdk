 ...
 */
public class EMSyncing extends Response<EMSyncing.Result> {

    @Override
    @JsonDeserialize(using = EMSyncing.ResponseDeserialiser.class)
    public void setResult(EMSyncing.Result result) {
    ...
    // these fields although not present in the RPC specification are returned by Aoa 1.4.10
