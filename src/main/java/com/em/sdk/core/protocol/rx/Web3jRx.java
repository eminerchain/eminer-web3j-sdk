...
public interface Web3jRx {
     ...
     *
     * @param EMFilter filter criteria
     * @return Observable that emits all Log events matching the filter
     */
    Observable<Log> ethLogObservable(EMFilter EMFilter);
     ...
     */
    Observable<EMBlock> blockObservable(boolean fullTransactionObjects);
     ...
     */
    Observable<EMBlock> replayBlocksObservable(
     ...
     */
    Observable<EMBlock> catchUpToLatestBlockObservable(
     ...
     */
    Observable<EMBlock> catchUpToLatestAndSubscribeToNewBlocksObservable(
        DefaultBlockParameter startBlock, boolean fullTransactionObjects);
