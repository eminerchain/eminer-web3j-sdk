...
//                               com.em.sdk.core.protocol.core.methods.response.Transaction.AOAAction
//                                   .CONTRACT_CREATE_TRX
//                                   .getValue());
//    }
...
//                               com.em.sdk.core.protocol.core.methods.response.Transaction.AOAAction.ORDINARY_TRX
//                                   .getValue());
//    }
     ...
     * 发送AOA交易
     */
    public static Transaction createEMTransaction(String from, String to, BigInteger nonce,
                                                  BigInteger value,
                                                  BigInteger gas, BigInteger gasPrice) {
        String subAddress = "";
        if (!org.springframework.util.StringUtils.isEmpty(to) && to.length() > 42) {
            subAddress = to;
...
//    }
    ...
    public static Transaction createEMCallTransaction(String from, String to, String data) {
