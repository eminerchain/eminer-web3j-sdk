...
/**
 * <p>Log object used by {@link EMLog} and {@link EMGetTransactionReceipt}.</p>
 * <p>It's not clear in the
 * <a href="https://github.com/ethereum/wiki/wiki/JSON-RPC#aoa_newfilter">docs</a>
 * If only a list of hashes are returned for filters created with aoa_newBlockFilter or
 * aoa_newPendingTransactionFilter.</p>
 */
public class Log {
