...
public class EMGetDelegateList extends Response<EMGetDelegateList.DelegateResult> {


    public EMGetDelegateList.DelegateResult getDelegateResult() {
        return getResult();
    }
    ...
    public static class DelegateObject extends EMGetDelegate.Delegate
        implements DelegateInterface<EMGetDelegate.Delegate> {
        ...
        @Override
        public EMGetDelegate.Delegate get() {
            return this;
        }
    }
    ...
    public static class ResponseDeserialiser extends JsonDeserializer<DelegateResult> {
        ...
        @Override
        public EMGetDelegateList.DelegateResult deserialize(
            JsonParser jsonParser,
            DeserializationContext deserializationContext) throws IOException {
            if (jsonParser.getCurrentToken() != JsonToken.VALUE_NULL) {
                return objectReader.readValue(jsonParser, EMGetDelegateList.DelegateResult.class);
            } else {
