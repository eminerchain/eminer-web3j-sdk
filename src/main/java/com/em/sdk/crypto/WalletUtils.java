...
import static com.em.sdk.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
import static com.em.sdk.crypto.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
import static com.em.sdk.utils.crypto.Hash.sha256;
...
public class WalletUtils {
    ...
    public static boolean isValidPrivateKey(String privateKey) {
        String cleanPrivateKey = Numeric.cleanHexOrAoaPrefix(privateKey);
        return cleanPrivateKey.length() == PRIVATE_KEY_LENGTH_IN_HEX;
    }

    public static boolean isValidAddress(String input) {
        String cleanInput = Numeric.cleanHexOrAoaPrefix(input);
