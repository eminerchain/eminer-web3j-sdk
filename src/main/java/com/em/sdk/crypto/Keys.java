...
import static com.em.sdk.crypto.SecureRandomUtils.secureRandom;
...
public class Keys {
    ...
    public static String getAddress(String publicKey) {
        String publicKeyNoPrefix = Numeric.cleanHexOrAoaPrefix(publicKey);
    ...
    public static String toChecksumAddress(String address) {
        String lowercaseAddress = Numeric.cleanHexOrAoaPrefix(address).toLowerCase();
        String addressHash = Numeric.cleanHexOrAoaPrefix(Hash.sha3String(lowercaseAddress));
