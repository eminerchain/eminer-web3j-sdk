...
public class RawTransaction {
    ...
    private final int totalAddressLength = 42;
    ...
    public RawTransaction(BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit, String to,
        ...
        this.to = to;
        if (!org.springframework.util.StringUtils.isEmpty(to) && to.length() > totalAddressLength) {
            this.subAddress = to;
     ...
     * 发送AOA交易
     */
    public static RawTransaction createEMTransaction(BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit,
