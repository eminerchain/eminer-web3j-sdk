...
import com.em.sdk.core.ens.EnsResolver;
...
import com.em.sdk.core.tx.Transfer;
import com.em.sdk.crypto.Credentials;
import com.em.sdk.crypto.WalletUtils;
import com.em.sdk.infura.InfuraHttpService;
...
import static com.em.sdk.codegen.Console.exitError;
...
//    }
    ...
    private Web3j getEthereumClient() {
        String clientAddress = console.readLine(
            "Please confirm address of running Aurora client you wish to send "
